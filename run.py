...
shutil.copy(inputs + '/' + udm_file, run_path + f"/{catchment_name}_LandCover_UDM.asc")
...
shutil.copy(f"{inputs}/{autocal_library}", run_path + '/' + autocal_library.replace(f'{catchment_name}_autocal_', ''))
...
print(f'running UDM using: ./shetran-setup-CEH2Types-linux {UDM_input}')
